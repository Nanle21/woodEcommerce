<?php
  ...
  $pagetitle ="Multiple Price Update";
  session_start();
                    ...
                    <!-- <p style="text-align: center;"><a href="add_product.php">Add a new Product</a></p> -->
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i> Multiple Price Update</h4>
                             <?php
                    ...
                    document.getElementById("myform").submit();
                            ...
                            <hr>
                              <thead>
                                ...
                                <tr>
                                  ...
                                  <th><i class="fa fa-bookmark"></i> Cost Price <input type="checkbox" id="cost_price" onclick="check()"></th>
                                  <th><i class="fa fa-bookmark"></i> Selling Price <input type="checkbox" id="selling_price" onclick="check1()"></th>
                                  <th><i class="fa fa-bookmark"></i> Quantity <input type="checkbox" id="qty" onclick="check2()"></th>
                              </tr>
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                ...
                                while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                                  ...
                                  ?>
                              <tr>
                                  <td><a href="view_product_detail.php?product_id=<?php echo $row['product_id']; ?>"><?php echo $row['product_name']; ?></a></td>
                                  <td class="hidden-phone"><?php echo $row['product_category']; ?></td>
                                  <td>
                                    <input type="text" name="fixPrice[]"  class="form-control" value="<?php echo $row['product_fixPrice']; ?>" id="cost_price_value[]">

                                  </td>
                                  <td>
                                    <input type="text" name="addedPrice[]" class="form-control" value="<?php echo $row['product_addedPrice']; ?>" id="selling_price_value[]" >
                                    <input type="hidden" name="product_id[]" value="<?php echo $row['product_id']; ?>">
                                  </td>
                                  <td>
                                    <input type="text" name="qty[]" id="quantity[]" class="form-control" value="<?php echo $row['product_quantity']; ?>" >
                                  </td>
                              </tr>
                              <?php
                                  //$ = 
                              ...
                              <div align="center">
                                <button class="btn btn-success" name="submit">Update Multiple Products</button>
                              </div> 
                          </form>
                             </tbody>
                             <?php
