      ...
      <?php include_once("tpl/header.php") ?>
       ...
       <section id="main-content">
        <section class="wrapper">
          <br>
          <p style="text-align: center;"><a href="view_category.php">View Categories</a></p>
            ...
            <div class="row-mt">
              <div class="col-md-6 col-md-offset-3">
                <div class="form-panel">
                  ...
                  <form class="form-horizontal style-form" action="processes/add_category_process.php" method="post" enctype = "multipart/form-data" id="myform">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="file" name="image" class="form-control" onchange="readURL(this);" accept="image/jpeg">
                      </div>
                    </div>
                    <div class="form-group">
