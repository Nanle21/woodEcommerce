      ...
      <?php include_once("tpl/header.php") ?>
       ...
       <section id="main-content">
        <section class="wrapper">
          <br>
          <p style="text-align: center;"><a href="add_user.php">Add a new User</a></p>
            <div class="row mt">
            ...
            ?>
                            <hr>
                              ...
                              <tr>
                                  ...
                                  <td class="hidden-phone"><?php echo $row['role'] ?></td>
                                  
                                  <td>
                                      
                                      <a href="edit_user.php?user_id=<?php echo $row['user_id']; ?>"><button class="btn btn-primary btn-xs" ><i class="fa fa-pencil"></i></button></a>
                                      <a href="delete_user.php?user_id=<?php echo $row['user_id']; ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                                  </td>
