...
<?php
  ...
  $user_detail = table_open("categories","_id='$_id'","","",__FILE__,__LINE__);
            ...
            <div class="row-mt">
              <div class="col-md-6 col-md-offset-3">
                <div class="form-panel">
                  ...
                  <form class="form-horizontal style-form" action="processes/edit_category_process.php?category_id=<?php echo $_id; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div align="center">
                       <div class="">
                        <div class="">
                            <div class="">
                                <div class="photo">
                                  <img  class="img-responsive" alt="" id="test" src="images/<?php echo $_id; ?>.jpg" >
                                </div>
