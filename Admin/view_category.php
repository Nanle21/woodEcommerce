      ...
      <?php include_once("tpl/header.php") ?>
       ...
       <section id="main-content">
        <section class="wrapper">
          <br>
          <p style="text-align: center;"><a href="add_category.php">Add a new Category</a></p>
            <div class="row mt">
                  <div class="col-md-12">
            ...
            ?>
                            <hr>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a href="edit_category.php?_id=<?php echo $row['_id']; ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                                      <a href="processes/delete_category_process.php?_id=<?php echo $row['_id']; ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                                  </td>
                              </tr>
                              <?php
                                }
