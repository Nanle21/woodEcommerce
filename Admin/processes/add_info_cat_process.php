...
$check = table_open("info_cat","title='$title'","","",__FILE__,__LINE__);
...
if($check['error'] == ""){
	$_SESSION['message'] = "Info Category already exist";
	$_SESSION['messagetype'] = "alert alert-danger";
	header("location: ../add_info_cat.php");
}
...
$add_info_cat = table_add_record("info_cat",$value,__FILE__,__LINE__,"insert");
if($add_info_cat!=""){
