      ...
      <?php include_once("tpl/header.php") ?>
       ...
       <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Add a New Asset</h3>
            <?php
            ...
            ?>
            <p style="text-align: center;"><a href="view_asset.php">View Assets</a></p>
            <div class="row-mt">
              <div class="col-md-6 col-md-offset-3">
                <div class="form-panel">
                  <h4 class="mb"><i class="fa fa-angle-right"></i> Please Fill in the Form to Add a New Assets</h4>
                  <form class="form-horizontal style-form" action="processes/add_asset_process.php" method="post" enctype="multipart/form-data">

                  <div align="center">
                    <div class="form-group">
                      <label class="col-sm-2 col-sm-2 control-label">Asset Name</label>
                          <div class="col-sm-10">
