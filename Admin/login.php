...
<html lang="en">
  ...
  <body class="">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <?php
            	if($pagetitle!="Login" && isset($_SESSION['current_user']))
				{
					?>
	  ...
	  <div id="login-page bg-overlay">
	  	<div class="container">
	  			...
	  			?>
		      <form class="form-login" action="processes/loginprocess.php" method="post" style="opacity: 0.8">
