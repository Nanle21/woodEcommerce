                    ...
                    <p style="text-align: center;"><a href="add_product.php">Add a new Product</a></p>
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i> View Product</h4>
                             <?php
              ...
              function categoryChange()
                {
                  var category = document.getElementById("category").value;
                   //var end_date = document.getElementById("end_date").value;
                    ...
                    document.getElementById("myform").action="view_product.php?category="+category;
                ...
                function seachrQ()
                {
                  var search = document.getElementById("search").value;
                   //var end_date = document.getElementById("end_date").value;
                    ...
                    document.getElementById("myform").action="view_product.php?search="+search;
                    document.getElementById("myform").submit();
                }
            </script>
                            <hr>
                              ...
                              <tr>
                                  ...
                                  <th><i class="fa fa-bookmark"></i> Main Price</th>
                                  <th></th>
                              </tr>
                              </thead>
                              <tbody>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $row['product_fixPrice']; ?></td>
                                  <td>
                                      <a href="product_edit.php?product_id=<?php echo $row['product_id']; ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                                      <a href="delete_product.php?product_id=<?php echo $row['product_id']; ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                                  </td>
                              </tr>
                              <?php
                                }
