      ...
      <?php include_once("tpl/header.php") ?>
       ...
       <section id="main-content">
        <section class="wrapper">
          <br>
          <p style="text-align: center;"><a href="view_expense.php">View expenses</a></p>
            <h3><i class="fa fa-angle-right"></i> Add a New Expense</h3>
            <?php
            ...
            <div class="row-mt">
              <div class="col-md-6 col-md-offset-3">
                <div class="form-panel">
                  <h4 class="mb"><i class="fa fa-angle-right"></i> Please Fill in the Form to Add a New User</h4>
                  <form class="form-horizontal style-form" action="processes/add_expense_process.php" method="post" enctype="multipart/form-data">
