...
<?php
  ...
  $user_detail = table_open("assets","_id='$_id'","","",__FILE__,__LINE__);
  if($user_detail['error']!="")
  {
  	$_SESSION["message"] = "Error encourtered accesing Assets Details";
  	$_SESSION["messagetype"] = "alert alert-danger";
  	header("Location: view_asset.php");
  	exit();
  }
  $_id = $user_detail[0]['_id'];
  $bank_name = $user_detail[0]['bank_name'];
  $account_number = $user_detail[0]['account_number'];
  $category = $user_detail[0]['category'];
  $description = $user_detail[0]['description'];
?>
            ...
            <div class="row-mt">
              <div class="col-md-6 col-md-offset-3">
                <div class="form-panel">
                  ...
                  <form class="form-horizontal style-form" action="processes/edit_asset_process.php?_id=<?php echo $_id; ?>" method="post">

                  <div align="center">
                      
                   <div align="center">
                    <div class="form-group">
                      <label class="col-sm-2 col-sm-2 control-label">Asset(Bank) Name</label>
                          <div class="col-sm-10">
                              <input type="text" class="form-control" name="bank_name" required="" value="<?php echo $bank_name; ?>">
                          </div>
                    </div>
                    <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Account Number</label>
                      <div class="col-sm-10">
                        <input type="text" name="account_number" class="form-control" required="" value="<?php echo $account_number; ?>">
                      </div>
                    </div>
